    ...
    public function generateBootstrapDotsLinks($url)
    {
        ...
        if ($this->getTotalPages() > 1) {
            ...
            if ($this->hasPreviousPage()) {
                $links .= '<li class="page-item"><a class="page-link" href="' . $url . '&p=' . $this->getPreviousPage() . '">Previous</a></li>';
            }
            ...
            if ($startPage > 1) {
                $links .= '<li class="page-item"><a class="page-link" href="' . $url . '&p=1">1</a></li>';
                if ($startPage > 2) {
            ...
            for ($i = $startPage; $i <= $endPage; $i++) {
                ...
                $links .= '<li class="page-item ' . $activeClass . '"><a class="page-link" href="' . $url . '&p=' . $i . '">' . $i . '</a></li>';
            }
            ...
            if ($endPage < $this->getTotalPages()) {
                ...
                $links .= '<li class="page-item"><a class="page-link" href="' . $url . '&p=' . $this->getTotalPages() . '">' . $this->getTotalPages() . '</a></li>';
            }

            if ($this->hasNextPage()) {
                $links .= '<li class="page-item"><a class="page-link" href="' . $url . '&p=' . $this->getNextPage() . '">Next</a></li>';
            }
