...
class AdvancedRequestValidator_hg
{
    private $allowedIPs = [];
    private $blockedIPs = [];
...
$config = [
    'allowed_ips' => ['192.168.1.0/24', '10.0.0.1', '192.168.2.100-192.168.2.200'],
    'blocked_ips' => ['192.168.1.10'],
    'allowed_user_agents' => ['Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36'],
    'blocked_user_agents' => ['MaliciousBot/1.0'],
    'whitelisted_urls' => ['/public', '/assets'],
    'blacklisted_urls' => ['/admin', '/secret'],
];

$validator = new AdvancedRequestValidator($config);
